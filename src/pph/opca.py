...
class PrincipalCompoent:
    ...
    def compute(self, dataset: ee.Image, region):
        ...
        centered = PrincipalCompoent.center_image(dataset, region, scale, band_names)
        ...
        sd_names = PrincipalCompoent.get_names('sd', n_bands)
        sd_image = (
        ...
        return (
            ...
            .arrayFlatten([PrincipalCompoent.get_names('pc', n_bands)])
